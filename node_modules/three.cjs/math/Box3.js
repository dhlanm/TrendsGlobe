 ...
 */
var SphereModule, getSphereModule = function () {
		return SphereModule = require('./Sphere');
	};
var Vector3Module = require('./Vector3');
var Box3;
var instance;
Box3 = function (min, max) {
	this.min = min !== undefined ? min : new Vector3Module.Vector3(Infinity, Infinity, Infinity);
	this.max = max !== undefined ? max : new Vector3Module.Vector3(-Infinity, -Infinity, -Infinity);
};
Box3.prototype = {
	constructor: Box3,
		...
		return function (object) {
			...
			object.traverse(function (node) {
				...
				if (geometry !== undefined) {
					if (!!(instance = geometry) && !!instance.isGeometry) {
					...
					} else if (!!(instance = geometry) && !!instance.isBufferGeometry && geometry.attributes['position'] !== undefined) {
	...
	getBoundingSphere: function () {
		...
		return function (optionalTarget) {
			var result = optionalTarget || new (SphereModule || (getSphereModule())).Sphere();
