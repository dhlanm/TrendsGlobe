...
var SphereModule = require('./Sphere');
var PlaneModule = require('./Plane');
var Frustum;
Frustum = function (p0, p1, p2, p3, p4, p5) {
	this.planes = [
		p0 !== undefined ? p0 : new PlaneModule.Plane(),
		p1 !== undefined ? p1 : new PlaneModule.Plane(),
		p2 !== undefined ? p2 : new PlaneModule.Plane(),
...
Frustum.prototype = {
	...
	intersectsBox: function () {
		var p1 = new Vector3Module.Vector3(), p2 = new Vector3Module.Vector3();
		return function (box) {
			var planes = this.planes;
			for (var i = 0; i < 6; i++) {
				var plane = planes[i];
