...
CurvePath.prototype = Object.create(CurveModule.Curve.prototype);
...
CurvePath.prototype.closePath = function () {
	...
	if (!startPoint.equals(endPoint)) {
		this.curves.push(new LineCurveModule.LineCurve(endPoint, startPoint));
	}
};
...
CurvePath.prototype.getBoundingBox = function () {
	...
	var p, i, il, sum;
	var v3 = !!(instance = points[0]) && !!instance.isVector3;
	sum = v3 ? new Vector3Module.Vector3() : new Vector2Module.Vector2();
...
CurvePath.prototype.createGeometry = function (points) {
	...
	for (var i = 0; i < points.length; i++) {
		geometry.vertices.push(new Vector3Module.Vector3(points[i].x, points[i].y, points[i].z || 0));
	}
	return geometry;
};
/**************************************************************
