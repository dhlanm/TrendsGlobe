...
var CubeTextureModule = require('../textures/CubeTexture');
var TextureModule = require('../textures/Texture');
var ImageLoaderModule = require('../loaders/ImageLoader');
var ImageUtils;
ImageUtils = {
	crossOrigin: undefined,
	loadTexture: function (url, mapping, onLoad, onError) {
		var loader = new ImageLoaderModule.ImageLoader();
		loader.crossOrigin = this.crossOrigin;
		var texture = new TextureModule.Texture(undefined, mapping);
	...
	loadTextureCube: function (array, mapping, onLoad, onError) {
		...
		var loader = new ImageLoaderModule.ImageLoader();
		loader.crossOrigin = this.crossOrigin;
		var texture = new CubeTextureModule.CubeTexture(images, mapping);
	...
	generateDataTexture: function (width, height, color) {
		...
		var texture = new DataTextureModule.DataTexture(data, width, height, Three.RGBFormat);
		texture.needsUpdate = true;
		return texture;
	}
};
