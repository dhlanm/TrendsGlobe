...
BoxGeometry = function (width, height, depth, widthSegments, heightSegments, depthSegments) {
	...
	function buildPlane(u, v, udir, vdir, width, height, depth, materialIndex) {
		...
		var gridX1 = gridX + 1, gridY1 = gridY + 1, segment_width = width / gridX, segment_height = height / gridY, normal = new Vector3Module.Vector3();
		...
		for (iy = 0; iy < gridY; iy++) {
			for (ix = 0; ix < gridX; ix++) {
				...
				var uva = new Vector2Module.Vector2(ix / gridX, 1 - iy / gridY);
				var uvb = new Vector2Module.Vector2(ix / gridX, 1 - (iy + 1) / gridY);
				var uvc = new Vector2Module.Vector2((ix + 1) / gridX, 1 - (iy + 1) / gridY);
				var uvd = new Vector2Module.Vector2((ix + 1) / gridX, 1 - iy / gridY);
				var face = new Face3Module.Face3(a + offset, b + offset, d + offset);
				...
				face = new Face3Module.Face3(b + offset, c + offset, d + offset);
				face.normal.copy(normal);
				face.vertexNormals.push(normal.clone(), normal.clone(), normal.clone());
				face.materialIndex = materialIndex;
				scope.faces.push(face);
...
BoxGeometry.prototype = Object.create(GeometryModule.Geometry.prototype);
