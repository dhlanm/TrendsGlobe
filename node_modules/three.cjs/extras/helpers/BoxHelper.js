...
BoxHelper = function (object) {
	...
	geometry.addAttribute('position', new BufferAttributeModule.BufferAttribute(new Float32Array(72), 3));
	LineModule.Line.call(this, geometry, new LineBasicMaterialModule.LineBasicMaterial({ color: 16776960 }), Three.LinePieces);
	if (object !== undefined) {
		this.update(object);
	}
};
BoxHelper.prototype = Object.create(LineModule.Line.prototype);
