...
MorphAnimMesh.prototype = Object.create(MeshModule.Mesh.prototype);
...
MorphAnimMesh.prototype.updateAnimation = function (delta) {
	...
	var keyframe = this.startKeyframe + MathModule.Math.clamp(Math.floor(this.time / frameTime), 0, this.length - 1);
...
MorphAnimMesh.prototype.clone = function (object) {
	if (object === undefined)
		object = new MorphAnimMesh(this.geometry, this.material);
...
MorphAnimMesh.prototype.isMorphAnimMesh = true;
