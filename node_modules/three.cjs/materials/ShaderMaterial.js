 ...
 * }
 */
var UniformsUtilsModule = require('../renderers/shaders/UniformsUtils');
...
ShaderMaterial.prototype = Object.create(MaterialModule.Material.prototype);
...
ShaderMaterial.prototype.clone = function () {
	...
	material.uniforms = UniformsUtilsModule.UniformsUtils.clone(this.uniforms);
