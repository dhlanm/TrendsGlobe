...
PerspectiveCamera.prototype = Object.create(CameraModule.Camera.prototype);
...
PerspectiveCamera.prototype.setLens = function (focalLength, frameHeight) {
	if (frameHeight === undefined)
		frameHeight = 24;
	this.fov = 2 * MathModule.Math.radToDeg(Math.atan(frameHeight / (focalLength * 2)));
	this.updateProjectionMatrix();
};
/**
...
PerspectiveCamera.prototype.updateProjectionMatrix = function () {
	var fov = MathModule.Math.radToDeg(2 * Math.atan(Math.tan(MathModule.Math.degToRad(this.fov) * 0.5) / this.zoom));
	if (this.fullWidth) {
		var aspect = this.fullWidth / this.fullHeight;
		var top = Math.tan(MathModule.Math.degToRad(fov * 0.5)) * this.near;
		var bottom = -top;
...
PerspectiveCamera.prototype.clone = function () {
	...
	CameraModule.Camera.prototype.clone.call(this, camera);
